...
return new class extends Migration
{
    ...
    {
        Schema::create('luaran_pengabdians', function (Blueprint $table) {
            $table->id();
            $table->foreignId('pengabdian_id')->constrained()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('luaran_pengabdians');
    }
};